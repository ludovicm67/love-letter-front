...
let messages = {
  fr: {
    ...
    Game: {
      ...
      winnerByElimination: 'Tous les joueurs ont été éliminés, sauf le gagnant, ',
      winnerByEmptyPile: 'La pioche est vide. Le joueur avec la meilleure main gagne : ',
      rounds: 'Manche ',
      rounds_2: ' sur ',
      clown: 'Clown',
  ...
  en: {
    ...
    Game: {
      ...
      winnerByElimination: 'All players are eliminated, except the winner, ',
      winnerByEmptyPile: 'The pile is empty. The player with the best hand is the winner : ',
      rounds: 'Round ',
      rounds_2: ' on ',
      clown: 'Clown',
